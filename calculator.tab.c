...
#line 22 "calculator.y"
                        { cout << "Result: " << (yyvsp[-1].num) << endl; }
#line 1069 "calculator.tab.c"
    break;

  case 4: /* expr: NUMBER  */
#line 25 "calculator.y"
                     { (yyval.num) = (yyvsp[0].num); }
#line 1075 "calculator.tab.c"
    break;

  case 5: /* expr: expr '+' expr  */
#line 26 "calculator.y"
                     { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1081 "calculator.tab.c"
    break;

  case 6: /* expr: expr '-' expr  */
#line 27 "calculator.y"
                     { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1087 "calculator.tab.c"
    break;

  case 7: /* expr: expr '*' expr  */
#line 28 "calculator.y"
                     { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1093 "calculator.tab.c"
    break;

  case 8: /* expr: expr '/' expr  */
#line 29 "calculator.y"
                     { if ((yyvsp[0].num) != 0) (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); else { yyerror("Division by zero"); exit(1); } }
#line 1099 "calculator.tab.c"
    break;

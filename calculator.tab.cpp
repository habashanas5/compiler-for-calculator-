...
#line 22 "calculator.y"
                        { cout << "Result: " << (yyvsp[-1].fval) << endl; }
#line 1069 "calculator.tab.cpp"
    break;

  case 4: /* expr: NUMBER  */
#line 25 "calculator.y"
                     { (yyval.fval) = (yyvsp[0].num); }
#line 1075 "calculator.tab.cpp"
    break;

  case 5: /* expr: expr '+' expr  */
#line 26 "calculator.y"
                     { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); }
#line 1081 "calculator.tab.cpp"
    break;

  case 6: /* expr: expr '-' expr  */
#line 27 "calculator.y"
                     { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].fval); }
#line 1087 "calculator.tab.cpp"
    break;

  case 7: /* expr: expr '*' expr  */
#line 28 "calculator.y"
                     { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].fval); }
#line 1093 "calculator.tab.cpp"
    break;

  case 8: /* expr: expr '/' expr  */
#line 29 "calculator.y"
                     { if ((yyvsp[0].fval) != 0) (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].fval); else { yyerror("Division by zero"); exit(1); } }
#line 1099 "calculator.tab.cpp"
    break;
